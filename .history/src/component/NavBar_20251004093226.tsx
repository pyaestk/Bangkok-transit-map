...
function NavBar() {
  ...
  const baseClasses =
    "px-3 py-2 rounded-xl text-sm border border-transparent block";
  ...
  return (
    <nav className="bg-[#0e1116cc] border-b border-[#232838] backdrop-blur-[5px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(5px)_brightness(100%)]">
      ...
      <div className={`md:hidden ${open ? "block" : "hidden"} bg-black/90`}>
