  ...
  return (
    <div className="p-4 rounded-2xl bg-gradient-to-b from-gray-900 to-gray-950 border border-gray-800 shadow-lg w-80 text-white">
      ...
      <div className="flex flex-col space-y-4 mt-4">
        <button className="px-4 py-2 rounded-lg bg-[#151922] border text-white hover:bg-white/10">Apply</button>
        <button className="px-4 py-2 rounded-lg bg-[#151922] border text-white hover:bg-white/10">Show In Planner</button>
      </div>
