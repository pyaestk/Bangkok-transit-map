  ...
  return (
    <div className="p-4 rounded-2xl bg-[linear-gradient(180deg,rgba(14,17,22,1)_0%,rgba(15,20,32,1)_100%)] border border-white/10 shadow-lg w-80 text-white">
      ...
      <div className="flex flex-col space-y-4 mt-4">
        <button className="px-4 py-2 rounded-lg bg-[#151922] border text-white border-white/10 hover:bg-white/20">Apply</button>
        <button className="px-4 py-2 rounded-lg bg-[#151922] border text-white border-white/10 hover:bg-white/20">Show In Planner</button>
      </div>
