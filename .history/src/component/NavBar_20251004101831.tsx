...
function NavBar() {
  ...
  const activeClasses = "bg-[#151922] border rounded-lg text-white border-white/10";
  ...
  return (
    <nav className="sticky top-0 z-50 bg-gray-950 border-b border-[#232838] backdrop-blur-[5px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(5px)_brightness(100%)]">
