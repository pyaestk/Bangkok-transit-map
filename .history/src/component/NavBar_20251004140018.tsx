...
function NavBar() {
  ...
  const activeClasses = "bg-[    <nav className="sticky top-0 z-50 bg-[#0a0a0aa9] border-b border-white/10 backdrop-blur-[50px]">
] border rounded-lg text-white border-white/10 backdrop-blur-[50px]";
