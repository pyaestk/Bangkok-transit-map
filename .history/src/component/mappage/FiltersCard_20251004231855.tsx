  ...
  return (
    <div className="border border-white/10 p-4 rounded-2xl bg-gradient-to-b from-gray-800 to-gray-900 shadow-lg w-80 text-white">
      ...
      <div className=" flex flex-col space-y-2 mt-4">
        <button className="border border-white/10 px-4 py-2 rounded-lg bg-gray-900 text-white hover:bg-white/10">
          Apply
        </button>
        <button className="border border-white/10 px-4 py-2 rounded-lg bg-gray-700 text-white hover:bg-white/10">
          Show In Planner
        </button>
      </div>
