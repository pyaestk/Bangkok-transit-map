...
export default function FiltersCard() {
  ...
  return (
    <div className="p-4 rounded-2xl bg-gradient-to-b from-gray-800 to-gray-900 border border-gray-800 shadow-lg w-80 text-white">
      ...
      {/* Buttons */}
      <div className="border border-white/10 flex flex-col space-y-4 mt-4">
