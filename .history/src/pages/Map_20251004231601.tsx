...
export default function Map() {
  return (
    <div className="flex flex-col md:flex-row gap-5 min-h-screen text-white">
      ...
      {/* Main */}
      <div className="relative border border-white/10 px-2 py-2 h-full flex-1 overflow-hidden rounded-2xl bg-gradient-to-b from-gray-800 to-gray-900 shadow-lg text-white">
