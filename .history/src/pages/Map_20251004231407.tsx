...
export default function Map() {
  return (
    <div className="flex flex-col md:flex-row gap-5 min-h-screen text-white">
      ...
      {/* Main */}
      <div className="relative border border-white/10 h-full flex-1 px-5 py-5 rounded-2xl bg-gradient-to-b from-gray-800 to-gray-900 shadow-lg text-white">
        <div className="bg-white rounded-lg h-[80vh] flex items-center justify-start relative">
          <TransformWrapper
            initialScale={0.5}
            minScale={0.1}
            maxScale={1}
